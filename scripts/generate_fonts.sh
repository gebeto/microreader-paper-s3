...
python scripts/generate_simplefont/cli.py --name MenuFontSmall --size 14 --chars-file resources/chars_input.txt --ttf resources/fonts/RobotoMono-SemiBold.ttf --out src/resources/fonts/other/MenuFontSmall.h
